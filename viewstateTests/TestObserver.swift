// From https://github.com/kickstarter/Kickstarter-ReactiveExtensions/blob/15631b40c437d18db4187d9b8ad117115775ea3f/ReactiveExtensions/test-helpers/TestObserver.swift
...
/**
 ...
 ```
 */
final class TestObserver <Value, Error: Swift.Error> {
    ...
    internal var values: [Value] {
        return self.events.filter { $0.value != nil }.map { $0.value! }
    }
    ...
    internal var didInterrupt: Bool {
        return self.events.filter { if case .interrupted = $0 { return true } else { return false } }.count > 0
    }
